...
public class AccountManagerController {
    ...
    private void loadData() throws RemoteException {
        ...
        accountIDTextField.setText(DAOProvider.dao.getAccountDAO().getNextAccountID());

        List<String> Ids = DAOProvider.dao.getEmployeeDAO().getTopThreeID();
        employeeIDSearchField.getItems().setAll(Ids);

        List<Account> AccountList = DAOProvider.dao.getAccountDAO().getAccount();
    ...
    private void handleSearchAction() throws RemoteException {
        ...
        if (searchText == null || searchText.isEmpty()) {
            accountList = DAOProvider.dao.getAccountDAO().getAccount();
        } else {
            accountList = DAOProvider.dao.getAccountDAO().findDataByContainsEmployeeCode(searchText);
    ...
    private void handleUpdateAction() {
        try {
            Account account = DAOProvider.dao.getAccountDAO().getAccountByEmployeeID(employeeIDCBox.getText());
            ...
            dialog.onClose(buttonType -> {
                if (buttonType == ButtonType.YES) {
                    try {
                        ...
                        DAOProvider.dao.getAccountDAO().updateData(account);
                        Platform.runLater(() -> {
