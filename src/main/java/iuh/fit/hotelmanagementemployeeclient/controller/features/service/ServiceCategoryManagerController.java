package iuh.fit.hotelmanagementemployeeclient.controller.features.service;
...
public class ServiceCategoryManagerController {
    ...
    private void loadData() {
        Task<ObservableList<ServiceCategory>> loadDataTask = new Task<>() {
            ...
            protected ObservableList<ServiceCategory> call() throws RemoteException {
                List<ServiceCategory> serviceCategories = DAOProvider.dao.getServiceCategoryDAO().findAll();
        ...
        loadDataTask.setOnSucceeded(e -> {
            ...
            try {
                Ids = DAOProvider.dao.getServiceCategoryDAO().getTopThreeID();
            } catch (RemoteException ex) {
                throw new RuntimeException(ex);
            }
            serviceCategoryIDSearchField.getItems().setAll(Ids);
            try {
                serviceCategoryIDTextField.setText(DAOProvider.dao.getServiceCategoryDAO().getNextServiceCategoryID());
            } catch (RemoteException ex) {
                throw new RuntimeException(ex);
            }
        });
    ...
    private void setupActionColumn() {
        actionColumn.setCellFactory(param -> new TableCell<>() {
            ...
            protected void updateItem(Void item, boolean empty) {
                ...
                try {
                    hasRoomInUse = DAOProvider.dao.getServiceCategoryDAO().isServiceCategoryInUse(serviceCategory.getServiceCategoryID());
        ...
        iconColumn.setCellFactory(column -> new TableCell<>() {
            ...
            protected void updateItem(String iconName, boolean empty) {
                ...
                if (empty || iconName == null) {
                    ...
                    String iconPath = "/iuh/fit/hotelmanagementemployeeclient/icons/service_icons/ic_" + iconName + ".png";
        ...
        try {
            ...
            Task<Void> addTask = new Task<>() {
                ...
                protected Void call() throws RemoteException {
                    DAOProvider.dao.getServiceCategoryDAO().createData(serviceCategory);
                    return null;
                }
            };
        ...
        dialog.onClose(buttonType -> {
            if (buttonType == ButtonType.YES) {
                Task<Void> deleteTask = new Task<>() {
                    @Override
                    protected Void call() throws RemoteException {
                        DAOProvider.dao.getServiceCategoryDAO().deleteData(serviceCategory.getServiceCategoryID());
                        return null;
                    }
                };
            ...
            dialog.onClose(buttonType -> {
                if (buttonType == ButtonType.YES) {
                    Task<Void> updateTask = new Task<>() {
                        @Override
                        protected Void call() throws RemoteException {
                            DAOProvider.dao.getServiceCategoryDAO().updateData(serviceCategory);
                            return null;
                        }
                    };
        ...
        Task<ObservableList<ServiceCategory>> searchTask = new Task<>() {
            ...
            protected ObservableList<ServiceCategory> call() throws RemoteException {
                List<ServiceCategory> serviceCategories = searchText == null || searchText.isEmpty()
                        ? DAOProvider.dao.getServiceCategoryDAO().findAll()
                        : DAOProvider.dao.getServiceCategoryDAO().findDataByContainsId(searchText);
                return FXCollections.observableArrayList(serviceCategories);
            }
        };
    ...
    private void setupIconSelector() {
        List<String> iconPaths = List.of(
                "/iuh/fit/hotelmanagementemployeeclient/icons/service_icons/ic_car.png",
                "/iuh/fit/hotelmanagementemployeeclient/icons/service_icons/ic_cleaning.png",
                "/iuh/fit/hotelmanagementemployeeclient/icons/service_icons/ic_food.png",
                "/iuh/fit/hotelmanagementemployeeclient/icons/service_icons/ic_karaoke.png",
                "/iuh/fit/hotelmanagementemployeeclient/icons/service_icons/ic_massage.png",
                "/iuh/fit/hotelmanagementemployeeclient/icons/service_icons/ic_meeting.png",
                "/iuh/fit/hotelmanagementemployeeclient/icons/service_icons/ic_washing.png"
        );
