...
public class InvoiceRevenueStatisticsTabController implements Initializable {
    ...
    // data of 3 years
    private final List<InvoiceDisplayOnTable> invoiceDisplayOnTableData = DAOProvider.dao.getInvoiceDisplayOnTableDAO().getDataThreeYearsLatest();
            ...
            Task<List<InvoiceDisplayOnTable>> task = new Task<>() {
                ...
                protected List<InvoiceDisplayOnTable> call() throws RemoteException {
                    if (allOfData.isEmpty()) {
                        return DAOProvider.dao.getInvoiceDisplayOnTableDAO().getAllData();
                    }
                    return allOfData;
                }
            };
