...
public class EmployeeSearchingController {
    ...
    private void handleEditEmployee(Employee employee) throws IOException {
        mainController.loadPanelEmployeeManagerController("/iuh/fit/hotelmanagementemployeeclient/view/features/employee/EmployeeManagerPanel.fxml", employee);
    }
    ...
    private void handleSearchAction() {
        try {
            ...
            List<Employee> searchResults = DAOProvider.dao.getEmployeeDAO().searchEmployee(
